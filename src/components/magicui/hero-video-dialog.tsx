...
export default function HeroVideoDialog({
  ...
  console.log("HeroVideoDialog rendered with:", { videoSrc, thumbnailSrc });

  return (
    <div className={cn("relative", className)}>
      <div
        className="group relative cursor-pointer bg-red-500/10"
        onClick={(e) => {
      ...
      >
        ...
        />
        <div className="absolute inset-0 flex scale-[0.9] items-center justify-center rounded-2xl transition-all duration-200 ease-out group-hover:scale-100 pointer-events-none">
      ...
      <AnimatePresence>
        {isVideoOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            onClick={() => {
              console.log("Modal background clicked - closing video");
